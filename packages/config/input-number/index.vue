<template>
  <div>
    ...
    <el-form-item v-loquat-has-perm="[data, 'minRows']" label="最小值">
      <el-input-number v-model.number="data.minRows"/>
    </el-form-item>
    <el-form-item v-loquat-has-perm="[data, 'maxRows']" label="最大值">
    ...
    <el-form-item v-loquat-has-perm="[data, 'precision']" label="精度">
      <el-input-number v-model.number="data.precision"/>
    </el-form-item>
    <el-form-item v-loquat-has-perm="[data, 'controlsPosition']" label="控制按钮位置">
