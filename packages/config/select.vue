<template>
  <div>
    ...
    <el-form-item v-loquat-has-perm="[originData, operationPerm, 1]" label="操作属性">
      <el-row>
        <el-col v-loquat-has-perm="[originData, 'multiple']" :span="operationComputedSpan">
        ...
        <el-col v-loquat-has-perm="[originData, 'filterable']" :span="operationComputedSpan">
        ...
        <el-col v-if="data.multiple" v-loquat-has-perm="[originData, 'drag']" :span="operationComputedSpan">
